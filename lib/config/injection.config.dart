...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i4.LocalRepository>(
      ...
      registerFor: {_prod});
  gh.singleton<_i5.OutRepository>(_i5.OutRepository(get<_i3.IomerDatabase>()),
      registerFor: {_prod});
  gh.singleton<_i6.InRepository>(_i6.InRepository(get<_i3.IomerDatabase>()),
      registerFor: {_prod});
  gh.factory<_i7.MatriculeBloc>(
      () => _i7.MatriculeBloc(
          get<_i4.LocalRepository>(), get<_i6.InRepository>()),
      registerFor: {_prod});
  gh.factory<_i8.SitesBloc>(
      () => _i8.SitesBloc(get<_i6.InRepository>(), get<_i4.LocalRepository>()),
      registerFor: {_prod});
  return get;
}
