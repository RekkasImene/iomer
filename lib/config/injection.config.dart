...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i10.InRepository>(
      _i10.InRepository(get<_i6.IomerDatabase>(), get<_i7.LocalRepository>(),
          get<_i5.Services>()),
      registerFor: {_prod});
  gh.factory<_i11.MatriculeBloc>(
      () => _i11.MatriculeBloc(
          get<_i7.LocalRepository>(), get<_i10.InRepository>()),
      registerFor: {_prod});
  gh.factory<_i12.SitesBloc>(
      () =>
          _i12.SitesBloc(get<_i10.InRepository>(), get<_i7.LocalRepository>()),
      registerFor: {_prod});
  return get;
}
