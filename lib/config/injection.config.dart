...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i6.OtBloc>(() => _i6.OtBloc(get<_i4.LocalRepository>()),
      registerFor: {_prod});
  gh.factory<_i7.OutRepository>(
      () => _i7.OutRepository(get<_i3.IomerDatabase>()),
      registerFor: {_prod});
  gh.singleton<_i8.InRepository>(_i8.InRepository(get<_i3.IomerDatabase>()),
      registerFor: {_prod});
  gh.factory<_i9.SitesBloc>(() => _i9.SitesBloc(get<_i8.InRepository>()),
      registerFor: {_prod});
  return get;
}
