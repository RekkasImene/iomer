...
import '../bloc/cloture/cloture_bloc.dart' as _i14;
...
import '../models/repository/out_repository.dart' as _i16;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i13.CategorieBloc>(
      ...
      registerFor: {_prod});
  gh.factory<_i14.ClotureBloc>(
      () => _i14.ClotureBloc(get<_i7.LocalRepository>()),
      registerFor: {_prod});
  gh.singleton<_i15.InRepository>(
      _i15.InRepository(get<_i6.IomerDatabase>(), get<_i7.LocalRepository>(),
          get<_i5.Services>()),
      registerFor: {_prod});
  gh.singleton<_i16.OutRepository>(
      _i16.OutRepository(get<_i6.IomerDatabase>(), get<_i5.Services>(),
          get<_i7.LocalRepository>(), get<_i15.InRepository>()),
      registerFor: {_prod});
  gh.factory<_i17.SitesBloc>(
      () =>
          _i17.SitesBloc(get<_i15.InRepository>(), get<_i7.LocalRepository>()),
      registerFor: {_prod});
  return get;
}
