...
import '../bloc/matricule/matricule_bloc.dart' as _i13;
import '../bloc/ot/ot_bloc.dart' as _i8;
import '../bloc/report/report_bloc.dart' as _i10;
import '../bloc/site/sites_bloc.dart' as _i14;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.CategorieBloc>(
      () => _i11.CategorieBloc(get<_i7.LocalRepository>()),
      registerFor: {_prod});
  gh.singleton<_i12.InRepository>(
      _i12.InRepository(get<_i6.IomerDatabase>(), get<_i7.LocalRepository>(),
          get<_i5.Services>()),
      registerFor: {_prod});
  gh.factory<_i13.MatriculeBloc>(
      () => _i13.MatriculeBloc(
          get<_i7.LocalRepository>(), get<_i12.InRepository>()),
      registerFor: {_prod});
  gh.factory<_i14.SitesBloc>(
      () =>
          _i14.SitesBloc(get<_i12.InRepository>(), get<_i7.LocalRepository>()),
      registerFor: {_prod});
  return get;
}
