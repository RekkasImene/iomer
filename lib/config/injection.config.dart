...
import '../bloc/matricule/matricule_bloc.dart' as _i4;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i4.MatriculeBloc>(
      () => _i4.MatriculeBloc(get<_i5.LocalRepository>()),
      registerFor: {_prod});
  ...
  gh.singleton<_i8.InRepository>(
      _i8.InRepository(get<_i3.IomerDatabase>(), get<_i5.LocalRepository>()),
      registerFor: {_prod});
  gh.factory<_i9.SitesBloc>(
      () => _i9.SitesBloc(get<_i8.InRepository>(), get<_i5.LocalRepository>()),
      registerFor: {_prod});
  return get;
}
